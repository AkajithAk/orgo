...
class _AdminChatPageState extends State<AdminChatPage> {
      ...
      child: Card(
        ...
        child: Container(
          ...
          child: Column(
            ...
            children: <Widget>[
              Text(_message, style: TextStyle(color: Colors.white, fontSize: 14)),
              Align(
  ...
  Widget _messageTextField() {
    return TextFormField(
      ...
      decoration: InputDecoration(border: InputBorder.none, hintText: appStateModel.blocks.localeText.type),
      autocorrect: false,
    );
  }
